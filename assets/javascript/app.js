...
// Creat a function that creates the start button and initial screen
  ...
  var answerArray = [["Brian De Palma", "Francis Ford Coppola", "Steven Spielberg", "Martin Scoresese"], ["Escaped prisoners from the Empire", "The main council of the Rebel Alliance", "The secret plans to the Death Star", "Untaxed death sticks"], ["Peter Mayhew and Anthony Daniels", "Frank Oz and Harrison Ford", "Anthony Daniels and Kenny Baker", "Mark Hamill and Carrie Fisher"], ["Droid", "Time machine", "Spaceship", "Space station"], ["Fourteen", "Twelve", "Eleven", "Ten"], 
